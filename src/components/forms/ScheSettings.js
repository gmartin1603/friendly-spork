...
function ScheSettings({ show, toggle }) {
  const [{ rota, shifts, archive, cols }, dispatch] = useAuthState();
            ...
            >
              ...
              {active?.segs ? (
                <FormInput
                  ...
                  chngTag={
                    active.segs.full !== rota.shifts[active.id].segs.full
                  }
              ...
              {Object.keys(active?.segs).length === 4 ? (
                <FormInput
                  ...
                  chngTag={
                    active.segs.three !== rota.shifts[active.id].segs.three
                  }
                  label={"Segment 3"}
                  type="text"
                  name="segs"
              ...
              >
                {group.keys.map((key) => (
                  <FormInput
                    ...
                    chngTag={
                      fields[group.label][key] !==
                      rota.fields[active.id][group.label][key]
                    }
                    style={styles.input}
                    label={key}
                    type="text"
